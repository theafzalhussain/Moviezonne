...
// ../../../AppData/Local/npm-cache/_npx/c943b712072b77c4/node_modules/wrangler/templates/modules-watch-stub.js
...
// .wrangler/tmp/bundle-JnN23D/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-JnN23D/middleware-insertion-facade.js
init_modules_watch_stub();
...
async function handleTmdbProxy(request, env, ctx, url) {
  ...
  return new Response(result.text, {
    ...
    headers: {
      ...
      // ← 3600 se 21600 kar do
    }
  });
}
__name(handleTmdbProxy, "handleTmdbProxy");
var MAX_BATCH_PATHS = 40;
var TMDB_CACHE_TTL = 21600;
var BATCH_CACHE_TTL = 7200;
